  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive web-based clinic management system for managing patient queues, doctor profiles, and appointments with real-time tracking.",
    ...
    },
    {
      ...
      description:
        "A full-stack CRUD application for managing employee records with secure data storage and RESTful API integration.",
    ...
    },
    {
      ...
      description:
        "A real-time detection model using YOLOv8 for multi-species recognition in diverse environments with 95% accuracy.",
    ...
    },
    {
      ...
      description:
        "A database-driven website to log and manage wildlife sightings with improved data retrieval and conservation reporting.",
